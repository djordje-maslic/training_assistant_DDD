...
class _$_InsufficientPermission implements _InsufficientPermission {
  ...
  @override
  String toString() {
    return 'ExerciseFailure.insufficientPermission()';
  }
...
abstract class _InsufficientPermission implements ExerciseFailure {
...
abstract class _UnableToUpdate implements ExerciseFailure {
