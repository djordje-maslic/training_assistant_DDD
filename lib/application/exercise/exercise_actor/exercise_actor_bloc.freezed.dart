...
// ignore: unused_element
  _Deleted deleted(Exercise exercise) {
    return _Deleted(
      exercise,
    );
  }
...
class _$_Deleted implements _Deleted {
  const _$_Deleted(this.exercise) : assert(exercise != null);
...
abstract class _Deleted implements ExerciseActorEvent {
  const factory _Deleted(Exercise exercise) = _$_Deleted;
...
mixin _$ExerciseActorState {
  ...
  Result when<Result extends Object>({
    ...
    @required Result deleteFailure(ExerciseFailure exerciseFailure),
  ...
  Result maybeWhen<Result extends Object>({
    ...
    Result deleteFailure(ExerciseFailure exerciseFailure),
