...
class _$SignInFormStateTearOff {
  ...
  _SignInFormState call(
    ...
    return _SignInFormState(
      ...
      authFailureUnitOption: authFailureUnitOption,
    );
  }
}
...
abstract class $SignInFormStateCopyWith<$Res> {
  ...
  $Res call(
      ...
      Option<Either<AuthFailure, Unit>> authFailureUnitOption});
}
...
class _$SignInFormStateCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    Object authFailureUnitOption = freezed,
  }) {
    return _then(_value.copyWith(
      ...
      authFailureUnitOption: authFailureUnitOption == freezed
          ? _value.authFailureUnitOption
          : authFailureUnitOption as Option<Either<AuthFailure, Unit>>,
    ));
  }
}
...
class _$_SignInFormState implements _SignInFormState {
  const _$_SignInFormState(
      ...
      @required this.authFailureUnitOption})
      : assert(emailAddress != null),
        assert(password != null),
        assert(isSubmitting != null),
        assert(showErrorMessages != null),
        assert(authFailureUnitOption != null);
  ...
  @override
  final Option<Either<AuthFailure, Unit>> authFailureUnitOption;

  @override
  String toString() {
    return 'SignInFormState(emailAddress: $emailAddress, password: $password, isSubmitting: $isSubmitting, showErrorMessages: $showErrorMessages, authFailureUnitOption: $authFailureUnitOption)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is _SignInFormState &&
            ...
            (identical(other.authFailureUnitOption, authFailureUnitOption) ||
                const DeepCollectionEquality().equals(
                    other.authFailureUnitOption, authFailureUnitOption)));
  }
